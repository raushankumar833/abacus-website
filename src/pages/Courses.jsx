...
import yourImage from "../assets/41.png";
  ...
  const courses = [
    {
      ...
      description:
        "Master mental arithmetic using the abacus tool. Perfect for beginners learning abacus basics and simple operations.",
      longDescription:
        "Master mental arithmetic using the abacus tool. This course is designed for children aged 5-15 years. Learn abacus basics and simple calculations step by step.",
      topics: [
    ...
    },
    {
      ...
      description:
        "Enhance calculation speed and accuracy with fun techniques. Advance to multi-digit calculations.",
      longDescription:
        "Enhance calculation speed and accuracy with fun techniques. For ages 6-15 years. Advance to multi-digit calculations and build mental math mastery.",
      topics: [
        "Mental Addition",
        "Mental Subtraction",
    ...
    },
    {
      ...
      description:
        "Learn fast calculation methods based on ancient techniques. Achieve speed, accuracy & excellence!",
      longDescription:
        "Learn fast calculation methods based on ancient techniques. For ages 8-15 years. Master Vedic mathematics sutras for lightning-fast calculations.",
      topics: [
        "Vedic Sutras",
        "Speed Calculations",
        "Square Roots",
    ...
    },
    {
      ...
      description:
        "Activities to improve memory, focus, and concentration. Building skills for ages 5-15 years.",
      longDescription:
        "Activities to improve memory, focus, and concentration. This course includes fun brain exercises, puzzles, and cognitive development activities.",
      topics: [
        "Memory Games",
        "Focus Exercises",
        "Concentration Tasks",
        ...
        <Container sx={{ py: 8 }}>
          ...
          >
            <Typography
              variant="h5"
              gutterBottom
              sx={{ fontWeight: 700, color: colors.darkBlue }}
            >
              COURSE LEVELS
            </Typography>
              ...
              <Grid item xs={12} md={4}>
                ...
                >
                  ...
                  <Typography variant="body2">
                    Learn abacus basics and simple operations.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                ...
                >
                  ...
                  <Typography variant="body2">
                    Advance to multi-digit calculations.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                ...
                >
                  <Typography
                    variant="h6"
                    sx={{ fontWeight: 700, color: colors.pink }}
                  >
                    EXPERT
                  </Typography>
                  <Typography variant="body2">
                    Achieve speed, accuracy & excellence!
                  </Typography>
                </Box>
              </Grid>
            </Grid>
                  ...
                  >
                    ...
                    <CardContent sx={{ flex: 1, p: 3 }}>
                      <Typography
                        variant="h5"
                        gutterBottom
                        sx={{ fontWeight: 800, color: course.color }}
                      >
                        {course.displayTitle}
                      </Typography>
                      ...
                      >
                        ...
                        <Box sx={{ ml: "auto" }}>
                          ...
                          <Typography
                            variant="h6"
                            sx={{ fontWeight: 700, color: course.color }}
                          >
                            {course.price}
                          </Typography>
                        </Box>
                      ...
                      {showEmailInput &&
                        selectedEnrollCourse?.id === course.id && (
    ...
    >
      <img 
        ...
        style={{
          ...
          maxWidth: "1200px",
          height: "auto",
          minHeight: { xs: "250px", sm: "350px", md: "450px", lg: "450px" },
          borderRadius: "16px",
          objectFit: "cover",
          display: "block",
          margin: "0 auto",
      ...
      />
        ...
        <Container
          sx={{ py: 8, maxWidth: "100% !important", px: { xs: 2, md: 0 } }}
        >
          <motion.div
            initial={{ scale: 0.95, opacity: 0 }}
            whileInView={{ scale: 1, opacity: 1 }}
              ...
              <Box>
                ...
                <Box sx={{ p: 3 }}>
                  <Typography
                    variant="h4"
                    gutterBottom
                    sx={{ fontWeight: 800, color: selectedCourse.color }}
                  >
                  ...
                  >
                    ...
                    <Chip
                      icon={<GroupIcon />}
                      label={`${selectedCourse.students}+ learners`}
                    />
                    <Chip
                      icon={<EmojiEventsIcon />}
                    ...
                    <Chip
                      ...
                      label={`${selectedCourse.videos} videos`}
                    />
                    <Chip
                      icon={<AssignmentIcon />}
                      label={`${selectedCourse.projects} projects`}
                    />
                  </Stack>
                  ...
                  <Grid container spacing={1} sx={{ mb: 3 }}>
                    {selectedCourse.topics.map((topic, idx) => (
                      <Grid item xs={12} sm={6} key={idx}>
                        ...
                        >
                          <CheckCircleIcon
                            sx={{ color: selectedCourse.color, fontSize: 20 }}
                          />
                  ...
                  <Grid container spacing={1} sx={{ mb: 3 }}>
                    {selectedCourse.benefits.map((benefit, idx) => (
                      <Grid item xs={12} sm={6} key={idx}>
                        ...
                        >
                          <StarIcon
                            sx={{ color: colors.yellow, fontSize: 20 }}
                          />
                  ...
                  >
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          bgcolor:
                            selectedCourse.color === colors.orange
                              ? colors.orangeDark
